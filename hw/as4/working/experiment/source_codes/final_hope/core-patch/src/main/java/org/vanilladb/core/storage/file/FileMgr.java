...
public class FileMgr {
	...
	private final Map<String, IoChannel> openFiles = new ConcurrentHashMap<String, IoChannel>();
	private static final Map<String, ReentrantReadWriteLock> concurrentMap = new ConcurrentHashMap<String, ReentrantReadWriteLock>();
