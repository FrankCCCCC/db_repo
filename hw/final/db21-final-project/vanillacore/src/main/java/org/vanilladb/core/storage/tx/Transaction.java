...
public class Transaction {
	private static int activeTxnsNum = 0;
	private static int activeReadOnlyTxnsNum = 0;
	...
	public static int getActiveTxnNum(){
		return activeTxnsNum;
	}
	public static int getActiveReadOnlyTxnNum(){
		return activeReadOnlyTxnsNum;
	}
}
=======
/*******************************************************************************
